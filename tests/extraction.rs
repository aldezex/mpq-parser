...
#[test]
fn extracts_tracker_events_from_real_replay() {
    let replay = std::fs::read("tests/fixtures/replay.SC2Replay").expect("fixture replay missing");
    ...
    println!("tracker block: {:?}", tracker_block);
